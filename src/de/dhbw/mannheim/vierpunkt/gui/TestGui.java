 ...
 * @param pusher
 */
public void verbindungsaufbau_Kanal(Pusher pusher){		
	...
	channel.bind("MoveToAgent", new PrivateChannelEventListener() {
	    public void onEvent(String channel1, String event, String data) {
	        ...
	        if (zug != -1){
	        // Zug des Gegners wird in Logik �bertragen
	        game.setChip(zug, 1);
	        ...
	        if (data.contains("true")){
	        	...
	        	// der von der Logik berechnete Move wird an den Pusher �bertragen
